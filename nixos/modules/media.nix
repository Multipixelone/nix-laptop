{
  ...
  systemd.services."playlist-downloader" = {
    ...
    script = ''
      ...
      playlist_names=( "monthly playlist" "forgotten faves" "good listening and learning" "slipped through" "vgm study" "amtrak")
      playlist_ids=( "24562" "48614" "20340" "26220" "53423" "26224")
